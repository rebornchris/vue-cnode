...
<div class="page">
  ...
  <div class="page__main">
    <div class="container">
      <div v-if="article">
        <VC-Article :article="article" :collectState="collectState" :editState="editState" @collect="handleCollect" @edit="handleEdit">

        </VC-Article>
        <Comments :comments="article.replies" :hasHost="!!host" @reply="handleReply" @ups="handleUps">
