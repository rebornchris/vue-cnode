<template>
  <header class="globalnav globalnav--fixed">
    ...
    <!--             <ul>
                  <li>
                    <a href="https://cnodejs.org/" target="_blank">�桤����</a>
                  </li>
                  <li>
                    <a href="https://github.com/jiananle/vue-cnode" target="_blank">��Ŀ��ַ</a>
                  </li>
                  <li>
                    <a href="https://jiananle.github.io/vue-cnode" target="_blank">Ԥ��</a>
                  </li>
                </ul> -->
              </div>
            </transition>
