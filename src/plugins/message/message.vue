<template>
<transition name="message-slide" type="animation" enter-active-class="animated bounceInRight" leave-active-class="animated bounceOutRight">
  <div class="message" :class="'message--' + type" v-show="visible" @mouseenter="clearTimer" @mouseleave="startTimer">
